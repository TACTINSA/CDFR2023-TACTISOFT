...
class OmniMovement:
    ...
    def forward(self, speed: int, distance: int = None):
        self.move_wheel(self.motor_ids.mot1, speed, False, distance)
        self.move_wheel(self.motor_ids.mot2, speed, True, distance)
        self.move_wheel(self.motor_ids.mot3, speed, True, distance)
