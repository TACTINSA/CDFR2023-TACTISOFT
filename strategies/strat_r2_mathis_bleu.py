...
async def run(robot: Robot):
    ...
    await robot.movement.async_forward(speed=100, duration=dist_to_time(300))#Etape 5
    ...
    await robot.movement.async_forward(speed=100, duration=dist_to_time(250))#Etape 12
    ...
    await robot.movement.async_backward(speed=100, duration=dist_to_time(250))#Etape 14
    await robot.movement.async_left(speed=100, duration=dist_to_time(1650))#Etape 15#156cm de déplacement
    await robot.movement.async_forward(speed=100, duration=dist_to_time(350))#Etape 16
