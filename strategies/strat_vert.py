...
async def run(robot: Robot):
    ...
    await robot.movement.async_forward(speed=100, duration=3)
    await robot.movement.async_turn_left(speed=100, duration=1.3)
    await robot.movement.async_forward(speed=100, duration=1.2)
    ...
    await robot.movement.async_right(speed=100, duration=5, stop_ir_after=0)
    await robot.movement.async_backward(speed=100, duration=2)
    await robot.movement.async_right(speed=100, duration=.4, stop_ir_after=0)
